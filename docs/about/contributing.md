...
mkdir zio
cd zio
git clone git@github.com:your-user-name/zio-insight-server.git .
```
...
You may have your own idea about what contributions to make to ZIO, which is great! If you want to make sure the ZIO contributors are open to your idea, you can [open an issue](https://github.com/zio/zio-insight-server/issues/new) first on the ZIO project site.

Otherwise, if you have no ideas about what to contribute, you can find a large supply of feature requests and bugs on the project's [issue tracker](https://github.com/zio/zio-insight-server/issues).
...
```bash
git pull git@github.com:zio/zio-insight-server.git master
```
...
Next, [open a new pull request](https://github.com/zio/zio-insight-server/compare) on GitHub, and select _Compare Across Forks_. On the right hand side, choose your own fork of the ZIO repository, in which you've been making your contribution.
